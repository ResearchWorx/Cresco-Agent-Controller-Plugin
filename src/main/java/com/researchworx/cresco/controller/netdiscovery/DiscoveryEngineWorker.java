...
class DiscoveryEngineWorker implements Runnable {
    ...
    private Map<NetworkInterface, MulticastSocket> workers;

    public DiscoveryEngineWorker(NetworkInterface networkInterface, Launcher plugin, Map<NetworkInterface, MulticastSocket> workers) {

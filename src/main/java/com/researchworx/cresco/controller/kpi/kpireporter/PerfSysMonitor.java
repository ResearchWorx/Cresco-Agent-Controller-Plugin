...
public class PerfSysMonitor {
    ...
    public PerfSysMonitor(Launcher plugin) {
        this.plugin = plugin;
        this.logger = new CLogger(PerfSysMonitor.class, plugin.getMsgOutQueue(), plugin.getRegion(), plugin.getAgent(), plugin.getPluginID(),CLogger.Level.Info);

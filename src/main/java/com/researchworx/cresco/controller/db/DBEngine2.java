...
public class DBEngine2 {
	...
	public DBEngine2(Launcher plugin) {

        this.plugin = plugin;
        logger = new CLogger(DBEngine2.class, plugin.getMsgOutQueue(), plugin.getRegion(), plugin.getAgent(), plugin.getPluginID(), CLogger.Level.Info);

...
public class DBApplicationFunctions2 {
    ...
    public DBApplicationFunctions2(Launcher plugin, DBEngine dbe) {
        this.logger = new CLogger(DBApplicationFunctions2.class, plugin.getMsgOutQueue(), plugin.getRegion(), plugin.getAgent(), plugin.getPluginID(), CLogger.Level.Debug);
        this.plugin = plugin;
    ...
    public void initCrescoDB()
    {
        try
        {
            ...
            //logger.debug("Create Tenant Vertex Class");
            //createVertexClass("Tenant");
            //createVertexIndex("Tenant", "tenant_od", true);

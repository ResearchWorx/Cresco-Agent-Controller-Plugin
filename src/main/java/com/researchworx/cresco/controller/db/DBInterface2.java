...
public class DBInterface2 {
    ...
    public DBInterface2(Launcher plugin) {
        this.logger = new CLogger(DBInterface2.class, plugin.getMsgOutQueue(), plugin.getRegion(), plugin.getAgent(), plugin.getPluginID(), CLogger.Level.Info);
        this.plugin = plugin;
